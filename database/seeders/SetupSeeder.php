...
class SetupSeeder extends Seeder
{
    public function run(): void
    {
        $setups = [
            ...
            ['short_title' => 'STH',   'title' => 'Stitching',       'type' => 'supplier_category'],
            ['short_title' => 'EMB',   'title' => 'Embroidery',      'type' => 'supplier_category'],
            ['short_title' => 'PRT',   'title' => 'Print',           'type' => 'supplier_category'],
            ['short_title' => 'CTP',   'title' => 'Cut to Pack',     'type' => 'supplier_category'],
            ...
            ['short_title' => 'STH|E', 'title' => 'Stitching | E',     'type' => 'worker_type'],
            ['short_title' => 'EMB|E', 'title' => 'Embroidery | E',    'type' => 'worker_type'],
            ['short_title' => 'PRT|E', 'title' => 'Print | E',         'type' => 'worker_type'],
            ['short_title' => 'CMT|E', 'title' => 'CMT | E',           'type' => 'worker_type'],
            ['short_title' => 'CTP|E', 'title' => 'Cut to Pack | E',   'type' => 'worker_type'],
        ];
