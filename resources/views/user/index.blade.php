                    ...
                    <x-slot name="actions">
                        ...
                        <div id="ac_in_modal">
                            ...
                            <button id="ac_in_btn" type="submit"
                                class="px-4 py-2 bg-[var(--bg-error)] border border-[var(--bg-error)] font-semibold rounded-lg hover:bg-[var(--h-bg-error)] transition-all duration-300 ease-in-out cursor-pointer">
                                In Active
                            </button>
                        </div>
                    </x-slot>
