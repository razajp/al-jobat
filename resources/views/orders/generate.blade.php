...
@section('content')
    ...
    <div class="mb-5 max-w-3xl mx-auto">
        <x-progress-bar 
            :steps="['Generate Order', 'View Order']" 
            :currentStep="1"
        />
    </div>
            ...
            <div class="flex justify-between gap-4">
                ...
                <div class="grow">
                    <x-select 
                        ...
                        class="grow"
                        withButton
                        btnId="generateOrderBtn"
                        btnText="Generate Order"
                    />
                </div>
            </div>
            {{-- rate showing --}}
    ...
    <script>
        ...
        function calculateTotalOrderAmount() {
            ...
            totalOrderAmount = new Intl.NumberFormat('en-US', { minimumFractionDigits: 1, maximumFractionDigits: 1 }).format(totalOrderAmount);
        }
