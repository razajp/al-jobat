            ...
            @if (in_array(Auth::user()->role, ['developer', 'owner', 'admin', 'accountant']))
                <div class="relative group">
                    <x-nav-link-item label="Expenses"
                        svgIcon='
                            <svg class="fill-[var(--text-color)] group-hover:fill-[var(--primary-color)]" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            @if (in_array(Auth::user()->role, ['developer', 'owner', 'admin', 'accountant', 'store_keeper']))
                <div class="relative group">
                    <x-nav-link-item label="Fabrics"
                        svgIcon='
                            <svg class="fill-[var(--text-color)] group-hover:fill-[var(--primary-color)]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150.73 150.73">
                                <path
        ...
        @if (in_array(Auth::user()->role, ['developer', 'owner', 'admin', 'accountant']))
            {
                ...
                subMenu: [
                    ...
                    {name: 'Deposit', href: "/daily-ledger/deposit"},
                    {name: 'Use', href: "/daily-ledger/use"},
                ]
            },
        @endif
        ...
        @if (in_array(Auth::user()->role, ['developer', 'owner', 'admin', 'accountant']))
            {
                ...
                subMenu: [
                    {name: 'Show Attendances', href: "/attendances"},
