...
<footer class="w-full bg-[var(--secondary-bg-color)] px-6 py-4 md:py-2 shadow-lg z-30 text-sm fade-in">
    <div class="container mx-auto flex justify-between items-center">
        @if (request()->is('users/create') || request()->is('suppliers/create') || request()->is('employees/create') || request()->is('articles/create') || request()->is('rates/create') || request()->is('productions/create') || request()->is('articles/*/edit') || request()->is('customers/*/edit') || request()->is('suppliers/*/edit') || request()->is('customers/create') || request()->is('orders/create') || request()->is('cr/create') || request()->is('shipments/create') || request()->is('shipments/*/edit') || request()->is('invoices/create') || request()->is('vouchers/create') || request()->is('cargos/create') || request()->is('reports/statement'))
        ...
        <div class="flex items-center gap-3">
            ...
            @endif
            @if (request()->is('users/create') || request()->is('suppliers/create') || request()->is('employees/create') || request()->is('articles/create') || request()->is('rates/create') || request()->is('productions/create') || request()->is('articles/*/edit') || request()->is('customers/*/edit') || request()->is('suppliers/*/edit') || request()->is('customers/create') || request()->is('orders/create') || request()->is('cr/create') || request()->is('shipments/create') || request()->is('shipments/*/edit') || request()->is('invoices/create') || request()->is('vouchers/create') || request()->is('cargos/create'))
