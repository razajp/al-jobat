function createCard(data) {
    ...
    let clutter = `
        <div id="${data.id}" data-json='${JSON.stringify(data)}' class="card relative border border-gray-600 shadow rounded-xl min-w-[100px] h-[8rem] flex gap-4 p-4 cursor-pointer overflow-hidden fade-in" onclick='generateModal(this)'>
