function createCard(data) {
    ...
    if (data.image) {
        clutter += `
            <div class="${data.classImg ?? ''} img aspect-square h-full ${!data.profile ? 'rounded-lg' : 'rounded-[41.5%]'} ${data.image && data.image == '/images/no_image_icon.png' ? 'p-1' : ''} overflow-hidden relative">
